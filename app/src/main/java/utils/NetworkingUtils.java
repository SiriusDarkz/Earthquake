...
public class NetworkingUtils {
    ...
    public static final String USGS_WEBAPI = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=4.5&limit=50";
